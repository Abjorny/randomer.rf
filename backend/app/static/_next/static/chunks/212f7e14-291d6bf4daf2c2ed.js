      ...
      (!(function (t) {
                ...
                if (
                  ...
                  if (this.fontFaces) {
                            ...
                            ((u = (function (t) {
                              ...
                              Object.keys(n).forEach(function (t) {
                                n[t].forEach(function (e) {
                                  ...
                                  switch (e) {
                                    case "bold":
                                      n = { family: t, weight: "bold" };
                                      break;
                                    case "italic":
                                      n = { family: t, style: "italic" };
                                      break;
                                    case "bolditalic":
                                      n = {
                                        family: t,
                    ...
                    for (
                      ...
                      if (
                        void 0 !==
                        this.pdf.internal.getFont(s[p], h, {
                          noFallback: !0,
                          disableWarning: !0,
                        })
                      ) {
                    ...
                    ((f = "" === f ? "Times" : f), this.pdf.setFont(f, h));
                  }
                }
              },
            }),
        ...
        d.prototype.drawImage = function (t, e, r, n, i, a, o, s, u) {
          ...
          var m = this.ctx.transform.decompose(),
            v = B(m.rotate.shx),
            w = new l(),
            L = (w = (w = (w = w.multiply(m.translate)).multiply(
              m.skew,
            )).multiply(m.scale)).applyToRectangle(
              new c(a - e * p, o - r * g, n * f, i * d),
            );
          if (this.autoPaging) {
            for (
              var S, _ = y.call(this, L), P = [], k = 0;
              k < _.length;
              k += 1
            )
            ...
            for (var F = P[0], I = P[P.length - 1], C = F; C < I + 1; C++) {
              ...
              if (0 !== this.ctx.clip_path.length) {
                var R = this.path;
                ((S = JSON.parse(JSON.stringify(this.ctx.clip_path))),
                  (this.path = x(
                    S,
              ...
              (T &&
                ...
                this.pdf
                  ...
                  .clip()
                  .discardPath()),
                this.pdf.addImage(t, "JPEG", D.x, D.y, D.w, D.h, null, null, v),
                T && this.pdf.restoreGraphicsState());
            }
          } else
            this.pdf.addImage(t, "JPEG", L.x, L.y, L.w, L.h, null, null, v);
        };
        var y = function (t, e, r) {
          ...
          L = function (t, e) {
            var r = this.fillStyle,
              ...
              i = this.lineCap,
              a = this.lineWidth,
              o = Math.abs(a * this.ctx.transform.scaleX),
              s = this.lineJoin;
            if (this.autoPaging) {
              for (
                var c,
              ...
              for (var v = f[0], L = f[f.length - 1], S = v; S < L + 1; S++) {
                ...
                if (0 !== this.ctx.clip_path.length) {
                  var C = this.path;
                  ((c = JSON.parse(JSON.stringify(this.ctx.clip_path))),
                    (this.path = x(
                      c,
                      this.posX + this.margin[3],
              ...
              ((this.lineWidth = o), A.call(this, t, e), (this.lineWidth = a));
          },
          A = function (t, e) {
            if (
        ...
        var P = function (t, e, r, n, i, a, o, s, c) {
          ...
          C = function (t) {
            ...
            var e,
              ...
              o = S.call(this, t.y),
              u = _.call(this, o) - a.h,
              h = this.ctx.transform.applyToPoint(new s(t.x, o));
            if (this.autoPaging) {
              ...
              for (
                var p = this.ctx.transform.applyToRectangle(
                  ...
                  g = d.applyToRectangle(new c(t.x, u, a.w, a.h)),
                  m = y.call(this, g),
                  v = [],
                  w = 0;
                w < m.length;
              ...
              for (var L = v[0], P = v[v.length - 1], k = L; k < P + 1; k++) {
                ...
                if (0 !== this.ctx.clip_path.length) {
                  ...
                  ((r = JSON.parse(JSON.stringify(this.ctx.clip_path))),
                    (this.path = x(r, this.posX + this.margin[3], -1 * q + F)),
                    A.call(this, "fill", !0),
                    (this.path = E));
                }
                var B = x(
                ...
                t.scale >= 0.01 &&
                  ((n = this.pdf.internal.getFontSize()),
                  this.pdf.setFontSize(n * t.scale),
                  (i = this.lineWidth),
                ...
                t.scale >= 0.01 &&
                  (this.pdf.setFontSize(n), (this.lineWidth = i));
              }
            } else
              (t.scale >= 0.01 &&
                ((n = this.pdf.internal.getFontSize()),
                ...
                (i = this.lineWidth),
                (this.lineWidth = i * t.scale)),
                this.pdf.text(t.text, h.x + this.posX, h.y + this.posY, {
                  angle: t.angle,
                  align: e,
                  renderingMode: t.renderingMode,
                  maxWidth: t.maxWidth,
          ...
          function e() {
            return (
              s.html2canvas
                ...
                : r.e(669).then(r.t.bind(r, 3561, 23))
            )
              .catch(function (t) {
        ...
        (R.API.addSvgAsImage = function (t, e, n, i, a, o, c, l) {
          ...
          return (
            s.canvg
              ...
              : Promise.all([r.e(194), r.e(107)]).then(r.bind(r, 6704))
          )
            .catch(function (t) {
